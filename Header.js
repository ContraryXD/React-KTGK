...
import { tdtttb } from "@/store/giohang";
...
export default function Header() {
    ...
    const thongBao = useSelector((state) => state.giohang.themsanpham)
    const tensp = useSelector((state) => state.giohang.tenspmoi)
    const dispatch = useDispatch();
    const openNotificationWithIcon = type => {
        api[type]({
            message: `Thêm sản phẩm ${tensp} vào giỏ hàng thành công`,
            description: '',
        });
    };
