              ...
              <div className="col-lg-12 text-center">
                <div style={{ padding: "50px 0" }}>
                  ...
                  <div style={{ marginTop: "20px" }}>
                    ...
                    <button className="primary-btn" style={{ margin: "5px" }} onClick={() => addToCart(10, 3)}>
                      ...
                      <tbody>
                        {cartItems.map((item) => (
                          <tr key={item.id}>
                            ...
                            <td className="shoping__cart__quantity">
                              <div className="quantity">
                                <div className="pro-qty">
                                  <button type="button" className="qtybtn" onClick={() => updateQuantity(item.id, item.quantity - 1)}>
                                    -
                                  </button>
                                  <input
                                    type="text"
                            ...
                            <td className="shoping__cart__total">{formatPrice(item.price * item.quantity)}</td>
                            <td className="shoping__cart__item__close">
                              <span className="icon_close" onClick={() => removeItem(item.id)} style={{ cursor: "pointer" }}></span>
                            </td>
                          </tr>
                        ))}
                      </tbody>
              ...
              <div className="row">
                <div className="col-lg-12">
                  <div className="shoping__cart__btns">
                    ...
                    <button type="button" className="primary-btn cart-btn cart-btn-right" onClick={() => fetchCart()}>
                      <span className="icon_loading"></span>
                      Refresh Cart
                    </button>
                    <button type="button" className="primary-btn cart-btn cart-btn-right" onClick={clearCart} style={{ marginLeft: "10px", backgroundColor: "#dc3545" }}>
                      Clear Cart
                    </button>
                  </div>
                </div>
                ...
                <div className="col-lg-6">
                  <div className="shoping__continue">
                    <div className="shoping__discount">
                      ...
                      {discount > 0 && <div style={{ marginTop: "10px", color: "green" }}>{(discount * 100).toFixed(0)}% discount applied!</div>}
                ...
                <div className="col-lg-6">
                  <div className="shoping__checkout">
                    ...
                    <ul>
                      ...
                      {discount > 0 && (
                        <li>
                          Discount ({(discount * 100).toFixed(0)}%) <span>-{formatPrice(calculateSubtotal() * discount)}</span>
                        </li>
                      )}
                      <li>
